...
export default function SignupPage() {
  ...
  useEffect(() => {
    getRedirectResult(auth)
      ...
      .catch((redirectError) => {
        setError(getSignupErrorMessage(redirectError))
      })
  }, [router])
  ...
  async function handleFederatedSignIn(providerName: "google" | "apple") {
    ...
    if (!provider) {
      setError("That sign-up option isn't ready yet.")
      return
    }
        ...
        <CardContent>
          <div className="grid gap-6">
            ...
            <form className="grid gap-4" onSubmit={handleSubmit}>
              ...
              <Button type="submit" className="w-full" disabled={isSubmitting || federatedLoading !== null}>
