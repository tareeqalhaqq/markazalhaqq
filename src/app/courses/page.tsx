    ...
    <div className="bg-background">
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 py-16 sm:py-24">
          <div className="mx-auto max-w-3xl text-center">
            <Badge className="border border-primary/20 bg-primary/10 text-primary">Seerah course</Badge>
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              MarkazalHaqq presently offers one dedicated programme: a 12-week live study of the Prophetic biography through the celebrated 100-line poem. The typography and presentation match the clarity of Rahmaniyyah.com and TareeqAlHaqq.org.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 pb-16">
        <div className="mx-auto max-w-4xl">
          {courses.map((course) => (
            <Card key={course.title} className="flex flex-col overflow-hidden border border-primary/15 bg-white/90 shadow-xl shadow-sky-100">
              {course.image && (
              ...
              <CardFooter className="flex flex-col items-start gap-4 border-t border-primary/10 bg-primary/5 p-8 sm:flex-row sm:items-center sm:justify-between">
                <div>
        ...
        <div className="mt-16 grid gap-10 rounded-3xl border border-primary/15 bg-white/90 p-10 shadow-xl shadow-sky-100 md:grid-cols-2">
          ...
          <div className="space-y-4 rounded-2xl border border-primary/15 bg-primary/5 p-8">
            <h3 className="font-headline text-2xl text-foreground">How to enrol</h3>
            <p className="text-base text-muted-foreground">
              Create your MarkazalHaqq account, complete the short intake form, and you will receive access details within one business day. Spots are limited to maintain a guided classroom experience.
            </p>
            <div className="flex flex-wrap gap-3">
              <Button asChild className="rounded-full px-6">
                <Link href="/signup">Start registration</Link>
              </Button>
